...
**🐉 EvoTrainer**  
  Developed [EvoTrainer](https://github.com/milannal1m/EvoTrainer), an AI-powered Pokémon battle agent, for the [VGC AI Competition 2025](https://gitlab.com/DracoStriker/pokemon-vgc-engine) using evolutionary algorithms to improve battle behavior through generational evolution.
